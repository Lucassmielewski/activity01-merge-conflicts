...
**Response**: Movies that pass the bechdel test have a much lower median budget, median domestic, and median international gross. 
...
**Response**: The notalk group has by far the highest budget, domestic, and international gross. Dubious and nowomen are roughly the same for budget and international gross, but dubious has a much higher domestic gross. While the 'ok' group has the lowest median budget and international gross. 
...
**Response**: All the groups have a very similar median ROI, but there is slightly more variation in the 'ok' group. There is no significant difference in any of the groups. 
